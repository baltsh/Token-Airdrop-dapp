!function e(t, r, n) {
    ...
    , {
        ...
        "@metamask/providers/dist/initializeInpageProvider": 29,
        loglevel: 65
    }],
    2: [function(e, t, r) {
        "use strict";
        ...
        class c extends i.default {
            ...
            _handleDisconnect(e, t) {
                if (this._state.isConnected || !this._state.isPermanentlyDisconnected && !e) {
                    ...
                    e ? (r = new o.EthereumRpcError(1013,t || u.default.errors.disconnected()),
                    this._log.debug(r)) : (r = new o.EthereumRpcError(1011,t || u.default.errors.permanentlyDisconnected()),
                    this._log.error(r),
                    this.chainId = null,
            ...
            _handleChainChanged({chainId: e}={}) {
                l.isValidChainId(e) ? (this._handleConnect(e),
            ...
            _handleAccountsChanged(e, t=!1) {
                ...
                s.default(this._state.accounts, r) || (t && null !== this._state.accounts && this._log.error("MetaMask: 'eth_accounts' unexpectedly updated accounts. Please report this bug.", r),
    ...
    , {
        "./messages": 30,
        "./utils": 34,
        "@metamask/safe-event-emitter": 39,
        "eth-rpc-errors": 49,
        "fast-deep-equal": 35,
        "json-rpc-engine": 63
    }],
    27: [function(e, t, r) {
        ...
        class l extends u.AbstractStreamProvider {
            constructor(e, {jsonRpcStreamName: t=r.MetaMaskInpageProviderStreamName, logger: n=console, maxEventListeners: i, shouldSendMetadata: s}={}) {
                if (super(e, {
                    jsonRpcStreamName: t,
                    logger: n,
                    maxEventListeners: i,
    ...
    28: [function(e, t, r) {
        ...
        class d extends c.BaseProvider {
            constructor(e, {jsonRpcStreamName: t, logger: r, maxEventListeners: n, rpcMiddleware: c}) {
                if (super({
                    logger: r,
                    maxEventListeners: n,
                    rpcMiddleware: c
                ...
                a.default(e, d, e, this._handleStreamDisconnect.bind(this, "MetaMask")),
                this._jsonRpcConnection = s.createStreamMiddleware({
                    retryOnMessage: "METAMASK_EXTENSION_CONNECT_CAN_RETRY"
                }),
                a.default(this._jsonRpcConnection.stream, d.createStream(t), this._jsonRpcConnection.stream, this._handleStreamDisconnect.bind(this, "MetaMask RpcProvider")),
    ...
    29: [function(e, t, r) {
        ...
        r.initializeProvider = function({connectionStream: e, jsonRpcStreamName: t, logger: r=console, maxEventListeners: s=100, shouldSendMetadata: a=!0, shouldSetOnWindow: u=!0, shouldShimWeb3: l=!1}) {
    ...
    , {
        "./middleware/createRpcWarningMiddleware": 31,
        "eth-rpc-errors": 49,
        "json-rpc-engine": 63
    }],
    35: [function(e, t, r) {
    ...
    , {
        "./createEngineStream": 36,
        "./createStreamMiddleware": 37
    }],
    39: [function(e, t, r) {
        "use strict";
        Object.defineProperty(r, "__esModule", {
 ...
 */
        ...
        function u(e, t, r) {
            ...
            var i = function(e) {
                ...
                if (void 0 !== e.length)
                    return "number" != typeof e.length || F(e.length) ? s(0) : d(e);
    ...
    50: [function(e, t, r) {
        ...
        r.serializeError = function(e, {fallbackError: t=s, shouldIncludeStack: r=!1}={}) {
            ...
            if (e && "object" == typeof e && !Array.isArray(e) && d(e, "code") && u(e.code)) {
                ...
                d(t, "data") && (l.data = t.data)) : (l.message = a(l.code),
                l.data = {
                    originalError: c(e)
                })
            } else {
            ...
            return r && e && f && "string" == typeof f && (l.stack = f),
            l
        }
    }
    , {
    ...
    53: [function(e, t, r) {
        ...
        r.read = function(e, t, r, n, i) {
            var o, s, a = 8 * i - n - 1, u = (1 << a) - 1, l = u >> 1, c = -7, d = r ? i - 1 : 0, f = r ? -1 : 1, h = e[t + d];
            for (d += f,
            o = h & (1 << -c) - 1,
            h >>= -c,
        ...
        r.write = function(e, t, r, n, i, o) {
            var s, a, u, l = 8 * o - i - 1, c = (1 << l) - 1, d = c >> 1, f = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, h = n ? 0 : o - 1, p = n ? 1 : -1, g = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
            for (t = Math.abs(t),
            ...
            u /= 2),
            s + d >= c ? (a = 0,
            s = c) : s + d >= 1 ? (a = (t * u - 1) * Math.pow(2, i),
 ...
 */
    ...
    , {
        "./JsonRpcEngine": 58,
        "./createAsyncMiddleware": 59,
        "./createScaffoldMiddleware": 60,
        "./getUniqueId": 61,
        "./idRemapMiddleware": 62,
        "./mergeMiddleware": 64
    }],
    64: [function(e, t, r) {
        "use strict";
    ...
    65: [function(e, t, r) {
        !function(e, r) {
            ...
            return l.noConflict = function() {
                return typeof window !== t && window.log === l && (window.log = d),
                l
            }
            ,
    ...
    , {
        ...
        "./internal/streams/destroy": 76,
        "./internal/streams/stream": 77,
        _process: 68,
        "core-util-is": 44,
        events: 43,
        inherits: 54,
